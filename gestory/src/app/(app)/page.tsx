    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-x-hidden">
      <main className="pt-0">
        ...
        >
          ...
          <div className="relative flex items-center justify-center min-h-120">
        ...
        <section id="fitur" className="bg-slate-50 py-28">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {/* Card 1 */}
              <div className="bg-white p-8 rounded-4xl border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-orange-100/60 transition-all duration-300 group hover:-translate-y-2">
              ...
              {/* Card 2 */}
              <div className="bg-white p-8 rounded-4xl border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-blue-100/60 transition-all duration-300 group hover:-translate-y-2">
              ...
              {/* Card 3 */}
              <div className="bg-white p-8 rounded-4xl border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-yellow-100/60 transition-all duration-300 group hover:-translate-y-2">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <ul className="space-y-5">
                  {[
                    ...
                    <li key={title} className="flex gap-4 items-start group">
                      <div
                        className={`w-12 h-12 rounded-2xl shrink-0 flex items-center justify-center bg-${color}-50 group-hover:bg-${color}-100 transition-colors`}
                      >
              ...
              <div className="space-y-8">
                ...
                {[
                  ...
                  <div
                    key={value}
                    className={`bg-linear-to-br ${bg} text-white p-8 rounded-3xl shadow-lg flex flex-col gap-2 hover:scale-105 transition-transform`}
                  >
